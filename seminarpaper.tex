...
Mutation testing is a fault-based testing technique. It applys changes to the input and creates a mutant. A mutant represents is a faulty program. In the best case the changes, which are applied by the mutator, represent mistakes a programmer would make.\cite{mutationssurvey:yue}
...
\subsection{ATL}
ATL is a hybrid model transformation language containing a mixture of
declarative and imperative constructs.
ATL is applied in the context of the
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=0.7\textwidth,natwidth=610,natheight=642]{figures/Overview of the ATL transformational approach.jpg}
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=0.7\textwidth,natwidth=610,natheight=642]{figures/Class
	metamodel.jpg}
...
\begin{figure}[tb]
	\centering
	\includegraphics[width=0.7\textwidth,natwidth=610,natheight=642]{figures/Relational
	metemodel.jpg}
